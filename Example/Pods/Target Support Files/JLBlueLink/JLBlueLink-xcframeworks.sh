...
{
  case "$1" in
  "JLBmpConvertKit.xcframework/ios-arm64")
    echo ""
    ;;
  "JLBmpConvertKit.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
  "JLDialUnit.xcframework/ios-arm64")
    echo ""
    ;;
  "JLDialUnit.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/../../JLBlueLink/Frameworks/JL_OTALib.xcframework" "JLBlueLink" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
